...
class Bot extends localStore_1.localStore {
  constructor(data) {
    ...
    this.forceSub = true;
    this.client.invoke.use((_a, next_1) =>
      __awaiter(this, [_a, next_1], void 0, function* ({ error }, next) {
  ...
  ApiStream(uniqueHash, req, res, forBot) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        if (req && res) {
          const fileData = yield model_1.fileModel.findOne({
            fileUniqueId: uniqueHash,
          });
          if (!fileData) {
          ...
          let temp;
          try {
            temp = yield this.client.sendDocument(
              streamWebHook,
              fileData.fileId
            );
          } catch (error) {
            ...
            setTimeout(
              () =>
                __awaiter(this, void 0, void 0, function* () {
                  ...
                  temp = yield this.client.getMessage(
                    streamWebHook,
                    Number(temp.id) + 1
                  );
          ...
          __awaiter(this, void 0, void 0, function* () {
            ...
            try {
              ...
              const channelId =
                ((_c =
                  (_b =
                    (_a = ctx.message.replyToMessage) === null || _a === void 0
                      ? void 0
                      : _a.forwardFrom) === null || _b === void 0
                    ? void 0
                    : _b.chat) === null || _c === void 0
                  ? void 0
                  : _c.id) || undefined;
              const userId = String(
                (_d = ctx.message.from) === null || _d === void 0
                  ? void 0
                  : _d.id
              );
              ...
              const channelName =
                ((_f =
                  (_e = ctx.message.replyToMessage) === null || _e === void 0
                    ? void 0
                    : _e.forwardFrom) === null || _f === void 0
                  ? void 0
                  : _f.chat.title) || undefined;
              ...
              const isAccessible = yield this.client.getMessage(
                channelId,
                INDEXmsgId
              );
              //   console.log(isAccessible);
              editedMsg = yield ctx.reply(
  ...
  getCurrentISTTime() {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const currentISTTime = (0, date_fns_1.format)(
        zonedTime,
        "yyyy-MM-dd HH:mm:ss"
      );
  ...
  listener() {
    return __awaiter(this, void 0, void 0, function* () {
      this.client.on("callbackQuery:data", (ctx) =>
        __awaiter(this, void 0, void 0, function* () {
          ...
          const msgId = Number(
            (_a = ctx.callbackQuery.message) === null || _a === void 0
              ? void 0
              : _a.id
          );
          const chatId = Number(
            (_b = ctx.callbackQuery.message) === null || _b === void 0
              ? void 0
              : _b.chat.id
          );
          ...
          if (callBackData.startsWith("STREAM")) {
            try {
              ...
              try {
                ...
                console.log(
                  "Sending error whem sending file for stream:::",
                  error
                );
              } finally {
                setTimeout(
                  () =>
                    __awaiter(this, void 0, void 0, function* () {
                      let url = yield this.client.getMessage(
                        streamWebHook,
                        Number(temp.id) + 1
                      );
                      if (!url.text) {
                        url = yield this.client.getMessage(
                          streamWebHook,
                          Number(temp.id) + 2
                        );
                      }
          ...
          if (callBackData.startsWith("POST")) {
            try {
              ...
              console.log(Data);
              const aud =
                (_c = Data.text) !== null && _c !== void 0 ? _c : undefined;
              const audio = aud.split("/")[3];
              const imdbDetails = yield (0, movier_1.getTitleDetailsByIMDBId)(
                url
              );
              const genre =
                imdbDetails.genres
              ...
              if (!imdbDetails.posterImage.url) {
                temp = yield this.client.sendPhoto(
                  this.postingChannel,
                  this.upiImage,
                  {
          ...
          if (callBackData.startsWith("-poster/")) {
            try {
              ...
              const url =
                ctx.callbackQuery.message.replyMarkup.inlineKeyboard[0][0].url;
              yield this.client.sendPhoto(
                this.posterChannelId,
                ctx.callbackQuery.message.photo.fileId,
                {
                  ...
                  replyMarkup: {
                    inlineKeyboard: [
                      ...
                      [
                        {
                          text: `Type @${this.inlineBot} ${number} ${file}`,
                          url,
                        },
                      ],
                    ],
          ...
          if (callBackData.startsWith("freePlan")) {
            try {
              ...
              if (!isIt) {
                yield this.mongo.Unlock(
                  String(userId),
                  this.client,
                  undefined,
                  true
                );
                const del = yield ctx.reply(
                  "<b>Your Premium Plan Has been Activated !\n\nTill TONIGHT!</b>",
                  {
                    parseMode: "HTML",
                  }
                );
                ...
                const del = yield ctx.reply(
                  "<b>🤣 you already used free now no more free trail. please buy subscription here are our 👉 /plan </b>",
                  {
                    parseMode: "HTML",
                  }
                );
          ...
          if (callBackData.startsWith("Series")) {
            try {
              ...
              query = query[1];
              const msgId =
                ((_d = ctx.msg) === null || _d === void 0 ? void 0 : _d.id) ||
                undefined;
              //  console.log(query, msgId)
              if (query && msgId) {
                const msgID = yield ctx.editMessageText(
                  msgId,
                  "Choose The Season You Need !",
                  {
                    replyMarkup: {
                      inlineKeyboard: [
                        [
          ...
          if (callBackData.startsWith("Quality")) {
            try {
              const msgId =
                ((_e = ctx.msg) === null || _e === void 0 ? void 0 : _e.id) ||
                undefined;
              const data = callBackData.split("/");
              if (!msgId) {
                  ...
                  replyMarkup: {
                    inlineKeyboard: [
                      [
                        {
                          text: "360p",
                          callbackData: `reQuery/${data[1]}/360p`,
                        },
                        {
                          text: "480p",
                          callbackData: `reQuery/${data[1]}/480p`,
                        },
                      ],
                      [
                        {
                          text: "720p",
                          callbackData: `reQuery/${data[1]}/720p`,
                        },
                        {
                          text: "1080p",
                          callbackData: `reQuery/${data[1]}/1080p`,
                        },
                      ],
                      [
                        {
                          text: "1440p",
                          callbackData: `reQuery/${data[1]}/1440p`,
                        },
                        {
                          text: "2160p",
                          callbackData: `reQuery/${data[1]}/2160p`,
                        },
                      ],
                    ],
                  },
          ...
          if (callBackData.startsWith("page")) {
            try {
              ...
              if (
                (_h =
                  (_g =
                    (_f = ctx === null || ctx === void 0 ? void 0 : ctx.msg) ===
                      null || _f === void 0
                      ? void 0
                      : _f.replyToMessage) === null || _g === void 0
                    ? void 0
                    : _g.from) === null || _h === void 0
                  ? void 0
                  : _h.id
              ) {
                if (
                  ctx.callbackQuery.from.id !== ctx.msg.replyToMessage.from.id
                ) {
                  yield ctx.answerCallbackQuery({
              ...
              const del = yield this.client.editMessageText(
                data[1],
                Number(data[2]),
                `< b > RESULTS: \n\nCurrent Page: ${
                  Number(data[3]) + 1
          ...
          if (callBackData.startsWith("ADS")) {
            try {
              ...
              if (this.isAdsOn) {
                ...
                this.isAdsOn = false;
                yield this.client.editMessageText(
                  `${chatId}`,
                  Number(msgId),
                  data,
                  {
          ...
          if (callBackData.startsWith("tutorial")) {
            try {
              ...
              const tempPool = yield this.paramsGroupPool(
                data[1],
                "tutorial",
                true
              );
            ...
            try {
              ...
              if (this.qrImage) {
                ...
                const sentMsg = yield ctx.replyPhoto(this.qrImage, {
                  ...
                  replyMarkup: {
                    inlineKeyboard: markup_1.Markup.qrReplyMarkup(
                      this.paymentScreenshotId
                    ),
                  },
                });
              }
          ...
          if (callBackData.startsWith("upi")) {
            try {
              ...
              yield ctx.replyPhoto(this.upiImage, {
                ...
                parseMode: "HTML",
                replyMarkup: {
                  inlineKeyboard: markup_1.Markup.upiReplyMarkup(
                    this.paymentScreenshotId
                  ),
                },
              });
          ...
          if (callBackData.startsWith("showPlans")) {
            yield ctx.editMessageText(msgId, this.planDescription, {
              replyMarkup: {
                inlineKeyboard: markup_1.Markup.planPriceReplyMarkup(
                  this.paymentScreenshotId
                ),
              },
            });
      ...
      this.client.on(":newChatMembers", (ctx) =>
        __awaiter(this, void 0, void 0, function* () {
          var _a, _b, _c, _d;
          try {
            const chatId = ctx.message.chat.id;
            const userName =
              ctx.message.from.firstName || ctx.message.from.userName;
            let channelName = (
              (_b =
                (_a = ctx === null || ctx === void 0 ? void 0 : ctx.message) ===
                  null || _a === void 0
                  ? void 0
                  : _a.chat) === null || _b === void 0
                ? void 0
                : _b.title
            )
            ...
            if (newMember == this.botDetails.username) {
              let channelName = (
                (_d =
                  (_c =
                    ctx === null || ctx === void 0 ? void 0 : ctx.message) ===
                    null || _c === void 0
                    ? void 0
                    : _c.chat) === null || _d === void 0
                  ? void 0
                  : _d.title
              )
                ? ctx.message.chat.title
                : "Channel";
              const d = yield this.client.sendMessage(
                ctx.message.chat.id,
                this.groupAddCaption(channelName),
                {
                  replyMarkup: {
                    inlineKeyboard: markup_1.Markup.newMemberReplyMarkup(
                      this.publicChannelUname,
                      this.paymentScreenshotId
                    ),
                  },
                  parseMode: "HTML",
              ...
              const chatDetails = yield ctx.getChatAdministrators(
                ctx.message.chat.id
              );
              const ownerdata = chatDetails.filter(
                (d) => d.status == "creator"
              );
            ...
            const d = yield ctx.reply(
              `<b>Hᴇʟʟᴏ ${userName} 😍, Aɴᴅ Wᴇʟᴄᴏᴍᴇ Tᴏ ${channelName} ❤️</b>\n\n<b>Just Send Any File Name ill SERCH Open Sourced Available files and <u>List YOU</u>.</b>`,
              {
                parseMode: "HTML",
                replyMarkup: {
                  inlineKeyboard: markup_1.Markup.groupJoinerReplyMarkup(
                    this.paymentScreenshotId
                  ),
                },
              }
  ...
  indexRounds(params) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        const messages = yield this.client.getMessages(
          params.channelId,
          fileArr
        );
        let finalSaved;
        ...
        for (const message of messages) {
          if (
            ...
            try {
              params.datas.skip++;
              console.log(
                "Ignoring non-file messages...",
                message,
                "ingoreeeeeeeeeeeeeeee"
              );
              console.log(message, "meessafe");
              yield this.client.forwardMessage(
                params.channelId,
                this.supportLog,
                message.id
              );
              ...
              if (error.errorMessage == "MESSAGE_ID_INVALID") {
                ...
                if (currentTasks > 0) {
                  ...
                  return yield params.ctx.editMessageText(
                    params.msgToModify,
  ...
  shortenUrlText(apiUrl, apiToken, dest) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        const url = `https://${apiUrl}/api?api=${apiToken}&url=${encodeURIComponent(
          dest
        )}`;
  ...
  commands() {
    return __awaiter(this, void 0, void 0, function* () {
      this.client.command("post", (ctx) =>
        __awaiter(this, void 0, void 0, function* () {
          var _a;
          try {
            const userID =
              (_a = ctx.message.from) === null || _a === void 0
                ? void 0
                : _a.id;
            console.log("25k");
      ...
      this.client.command("bcast", (ctx) =>
        __awaiter(this, void 0, void 0, function* () {
          try {
          } catch (error) {}
        })
      );
      this.client.command("gcast", (ctx) =>
        __awaiter(this, void 0, void 0, function* () {
          var _a, _b;
          try {
            const userID =
            ...
            if (this.admin.includes(String(userID))) {
              ...
              const picture =
                ((_b = isReplied.photo) === null || _b === void 0
                  ? void 0
                  : _b.fileId) || undefined;
      ...
      this.client.command("set_admin", (ctx) =>
        __awaiter(this, void 0, void 0, function* () {
          var _a;
          try {
      ...
      this.client.command("filelog", (ctx) =>
        __awaiter(this, void 0, void 0, function* () {
          var _a, _b, _c;
          try {
            const userID =
            ...
            if (!isRepied) {
              yield ctx.reply(
                "forward A message from fileLog channel and Reply it with fileLog !"
              );
              return;
            }
            const isChatId =
              ((_c =
                (_b = isRepied.forwardFrom) === null || _b === void 0
                  ? void 0
                  : _b.chat) === null || _c === void 0
                ? void 0
                : _c.id) || undefined;
      ...
      this.client.command("qr", (ctx) =>
        __awaiter(this, void 0, void 0, function* () {
          ...
          try {
            ...
            const fileId =
              ((_b = isRepied.photo) === null || _b === void 0
                ? void 0
                : _b.fileId) || undefined;
            if (!fileId) {
            ...
            const change = yield this.mongo.editBotModel(
              this.botToken,
              fileId,
              "qrFileId"
            );
        ...
        __awaiter(this, void 0, void 0, function* () {
          ...
          try {
            ...
            if (
              ...
              const changeBotModel = yield this.mongo.editBotModel(
                this.botToken,
                data[1],
                "upiId"
              );
      ...
      this.client.command("commands", (ctx) =>
        __awaiter(this, void 0, void 0, function* () {
          var _a;
          try {
      ...
      this.client.command("set_qr", (ctx) =>
        __awaiter(this, void 0, void 0, function* () {
          var _a, _b;
          try {
            const userId = String(
              (_a = ctx.message.from) === null || _a === void 0 ? void 0 : _a.id
            );
            const chatType = String(ctx.message.chat.type);
            const isReplied =
              ((_b = ctx.message.replyToMessage) === null || _b === void 0
                ? void 0
                : _b.photo) || undefined;
      ...
      this.client.command("set_benefitvideo", (ctx) =>
        __awaiter(this, void 0, void 0, function* () {
          var _a, _b;
          try {
            const userId = String(
      ...
      this.client.command("admin", (ctx) =>
        __awaiter(this, void 0, void 0, function* () {
          ...
          try {
            ...
            const data = yield this.mongo.adminReport(this.isAdsOn);
            const chatId = String(
              (_a = ctx.message.chat) === null || _a === void 0 ? void 0 : _a.id
            );
            if (data) {
              if (this.isAdsOn) {
      ...
      this.client.command("forceSub", (ctx) =>
        __awaiter(this, void 0, void 0, function* () {
          var _a, _b;
          try {
            const userId =
            ...
            const isReplied = ctx.message.replyToMessage || undefined;
            if (
              this.admin.includes(String(userId)) &&
              isReplied &&
              ((_b = isReplied.forwardFrom) === null || _b === void 0
                ? void 0
                : _b.type) == "channel"
            ) {
              const forceSubId = isReplied.forwardFrom.chat.id;
              this.forceSubChatId = String(forceSubId);
              const createInviteLink = yield this.client.createInviteLink(
                forceSubId
              );
              ...
              if (isReplied.forwardFrom.chat.id) {
                ...
                yield this.mongo.editBotModel(
                  this.botToken,
                  String(isReplied.forwardFrom.chat.id),
                  "forceSubChatId"
                );
            ...
            if (error.errorMessage === "CHANNEL_PRIVATE") {
              return ctx.reply(
                "Add Bot as Admin With All Rights !\n\nAnd Try Again"
              );
            }
      ...
      this.client.command("tutorial", (ctx) =>
        __awaiter(this, void 0, void 0, function* () {
          var _a, _b;
          try {
            const userId =
            ...
            const chatType = ctx.message.chat.type;
            if (this.admin.includes(String(userId))) {
              const isRepliedVideo =
                ((_b = ctx.message.replyToMessage) === null || _b === void 0
                  ? void 0
                  : _b.video) || undefined;
              if (!isRepliedVideo) {
                yield ctx.reply(
                  "Send to Video File and reply it with \n\n/tutorial \n\nto set Universal tutorial"
                );
                return;
              }
              ...
              yield ctx.replyVideo(this.tutorialUrl);
              const edited = yield this.mongo.editBotModel(
                this.botToken,
                this.tutorialUrl,
                "tutorialVideo"
              );
            ...
            if (chatType == "private") {
              ...
              const groupDetails = yield this.paramsGroupPool(
                chatId,
                "userTutorial"
              );
              if (!groupDetails) {
      ...
      this.client.command("set_shortner", (ctx) =>
        __awaiter(this, void 0, void 0, function* () {
          var _a;
          try {
            const senderId =
            ...
            if (msgFrom == "private") {
              const del = yield ctx.reply(
                "ADD Me to Your Group and Use the Command there"
              );
              setTimeout(() =>
                __awaiter(this, void 0, void 0, function* () {
                  yield ctx.deleteMessage(del.id);
            ...
            if (msgFrom == "group" || "supergroup") {
              ...
              const data = text.split("/");
              const isValidUrl = yield this.shortenUrlText(
                data[2],
                data[3],
                "www.instagram.com"
              );
              if (isValidUrl.length < 1) {
                yield ctx.deleteMessage(msgId);
                yield ctx.reply(
                  "<b>Invalid Url or TOKEN / CONTACT ADMIN !!</b>",
                  {
                    replyMarkup: {
                      inlineKeyboard: markup_1.Markup.contactAdminReplyMarkup(
                        this.contactAdmin
                      ),
                    },
                    parseMode: "HTML",
      ...
      this.client.command("set_tutorial", (ctx) =>
        __awaiter(this, void 0, void 0, function* () {
          var _a, _b;
          try {
            ...
            if ((msgFrom == "supergroup" || "group") && fileAvailable) {
              ...
              if (parseInt(ownerUserId) !== parseInt(senderId)) {
                let del = yield ctx.reply(
                  "UnAuth. Command only for Owner of the Group!"
                );
                setTimeout(
                  () =>
                    __awaiter(this, void 0, void 0, function* () {
      ...
      this.client.command("myPlan", (ctx) =>
        __awaiter(this, void 0, void 0, function* () {
          var _a, _b, _c, _d;
          try {
            yield this.mongo.isExist(
              String(
                (_a = ctx.message.from) === null || _a === void 0
                  ? void 0
                  : _a.id
            ...
            const isPremiumExpired = yield this.mongo.isVerified(
              String(
                (_b = ctx.message.from) === null || _b === void 0
                  ? void 0
                  : _b.id
              )
            );
            if (isPremiumExpired == "notVerified") {
              yield ctx.reply(
                `Hey ${
                  ((_c = ctx.message.from) === null || _c === void 0
                    ? void 0
                    : _c.firstName) || "user"
      ...
      this.client.command("start", (ctx, next) =>
        __awaiter(this, void 0, void 0, function* () {
          ...
          try {
            ...
            if (vals.startsWith("/start hash_")) {
              ...
              const del = yield ctx.reply(
                "<b>You are Unlocked Till Today ENJOY</b>",
                {
                  parseMode: "HTML",
                }
              );
              ...
              try {
                ...
                yield (0, sendFile_1.sendContent)(
                  ctx,
                  this.client,
                  this.isAdsOn,
                  pool.fileId,
            ...
            if (vals.startsWith("/start file_")) {
              ...
              if (match) {
                ...
                if (isVerified == "ban") {
                  yield ctx.reply(
                    "YOU ARE BANNED BY OUR TEAM !!\n\nContact: Admin",
                    {
                      replyMarkup: {
                        inlineKeyboard: markup_1.Markup.bannedReplyMarkup(
                          this.paymentScreenshotId
                        ),
                      },
                    }
                ...
                const isPower = yield this.paramsGroupPool(
                  String(chatId),
                  "userPowering",
                  true
                );
                ...
                let tutorialUrl;
                if (!isPower) {
                  shortenedUrl = yield this.shortenUrlText(
                    this.apiUrl,
                    this.apiToken,
                    endPoint
                  );
                ...
                if (
                  ...
                  if (tutorialUrl) {
                    let pool = this.addPool(
                      String(
                        (_e = ctx.message.from) === null || _e === void 0
                          ? void 0
                          : _e.id
                      ),
                      hash,
                    ...
                    if (this.admin.includes(userId)) {
                      yield ctx.reply(
                        `🫂 ʜᴇʏ.. ${
                          ((_f = ctx.message.from) === null || _f === void 0
                            ? void 0
                            : _f.firstName) || "user"
                      ...
                      yield ctx.reply(
                        `🫂 ʜᴇʏ.. ${
                          ((_g = ctx.message.from) === null || _g === void 0
                            ? void 0
                            : _g.firstName) || "user"
                        }\n\n✅ ʏᴏᴜʀ ʟɪɴᴋ ɪꜱ ʀᴇᴀᴅʏ, ᴋɪɴᴅʟʏ ᴄʟɪᴄᴋ ᴏɴ ᴅᴏᴡɴʟᴏᴀᴅ ʙᴜᴛᴛᴏɴ.\n\n⚠️ ꜰɪʟᴇ ɴᴀᴍᴇ : ${
                          fileData.fileName
                    ...
                    let pool = this.addPool(
                      String(
                        (_h = ctx.message.from) === null || _h === void 0
                          ? void 0
                          : _h.id
                      ),
                      hash,
                    ...
                    if (this.admin.includes(userId)) {
                      yield ctx.reply(
                        `🫂 ʜᴇʏ.. ${
                          ((_j = ctx.message.from) === null || _j === void 0
                            ? void 0
                            : _j.firstName) || "user"
                        }\n\n✅ ʏᴏᴜʀ ʟɪɴᴋ ɪꜱ ʀᴇᴀᴅʏ, ᴋɪɴᴅʟʏ ᴄʟɪᴄᴋ ᴏɴ ᴅᴏᴡɴʟᴏᴀᴅ ʙᴜᴛᴛᴏɴ.\n\n⚠️ ꜰɪʟᴇ ɴᴀᴍᴇ : ${
                          fileData.fileName
                      ...
                      yield ctx.reply(
                        `🫂 ʜᴇʏ.. ${
                          ((_k = ctx.message.from) === null || _k === void 0
                            ? void 0
                            : _k.firstName) || "user"
                        }\n\n✅ ʏᴏᴜʀ ʟɪɴᴋ ɪꜱ ʀᴇᴀᴅʏ, ᴋɪɴᴅʟʏ ᴄʟɪᴄᴋ ᴏɴ ᴅᴏᴡɴʟᴏᴀᴅ ʙᴜᴛᴛᴏɴ.\n\n⚠️ ꜰɪʟᴇ ɴᴀᴍᴇ : ${
                          fileData.fileName
                  ...
                  try {
                    ...
                    yield this.fileLogs(this.client, {
                      userId,
                      userName:
                        ((_l = ctx.message.from) === null || _l === void 0
                          ? void 0
                          : _l.firstName) || "USER",
            ...
            if (vals == "/start") {
              const name =
                ((_m = ctx.message.from) === null || _m === void 0
                  ? void 0
                  : _m.firstName) || "User";
              ...
              yield ctx.reply(this.startCaption(name), {
                parseMode: "HTML",
                replyMarkup: {
                  inlineKeyboard: markup_1.Markup.introReplyMarkup(
                    String(this.botUname),
                    this.publicChannelUname
                  ),
                },
              });
  ...
  fileSaver() {
    return __awaiter(this, void 0, void 0, function* () {
      this.client.on("message", (ctx, next) =>
        __awaiter(this, void 0, void 0, function* () {
          try {
            ...
            if (this.fileLog.includes(String(ctx.message.chat.id))) {
              ...
              yield ctx.reply(
                this.startCaption(ctx.message.from.firstName || "USER"),
                {
                  parseMode: "HTML",
                  replyMarkup: {
                    inlineKeyboard: markup_1.Markup.introReplyMarkup(
  ...
  groupManager() {
    return __awaiter(this, void 0, void 0, function* () {
      this.client.on("message:text", (ctx, next) =>
        __awaiter(this, void 0, void 0, function* () {
          var _a, _b, _c;
          try {
            ...
            const text = ctx.message.text;
            if (
              (typeMedium == "group" || typeMedium == "supergroup") &&
              !text.startsWith("/")
            ) {
              const query = {
                query: text,
  ...
  queryManager(ctx, userId, Query, chatId, firstName, chatTitle) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        if (!exist && this.forceSubUrl) {
          editedMsg = yield ctx.reply(
            "<b>Hey Hey Heyyy..\n\nYou Need to JOIN my Channel to USE ME!😜\n\n Join My Channel to Use ME! and Type Again .</b>",
            {
              parseMode: "HTML",
              replyMarkup: {
                inlineKeyboard: markup_1.Markup.forceSubReplyMarkup(
                  this.forceSubUrl
                ),
              },
            }
        ...
        if (file.length > 0) {
          const fileAsReplyMarkup = this.savingReplyMarkup(
            Query.query,
            file,
            8,
            String(chatId),
    ...
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        if (error.message === "400: CHANNEL_INVALID (channels.getChannels)") {
          throw new Error(
            "ADd button to Force SUb channel... reason: channel private"
          );
        }
